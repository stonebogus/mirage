...
using SceneGraph = Mirage.Graph.Graph;
...
public class NodeUpdateChannelTest
{
    ...
    {
        var graph = new SceneGraph(new Node("Root"));
    ...
    [Fact]
    public void Constructor_WithNullGraph_Throws()
    {
        Assert.Throws<ArgumentNullException>(() => new NodeUpdateChannel(null!));
    }
    ...
    public void Update_DoesNotUpdateUnloadedNodes()
    {
        ...
        var channel = new NodeUpdateChannel(new SceneGraph(root));
